...
func (_Usdt *UsdtTransactor) AllocateTo(opts *bind.TransactOpts, _owner common.Address, value *big.Int) (*types.Transaction, error) {
	return _Usdt.contract.Transact(opts, "allocateTo", _owner, value)
}

// AllocateTo is a paid mutator transaction binding the contract method 0x08bca566.
//
// Solidity: function allocateTo(address _owner, uint256 value) returns()
func (_Usdt *UsdtSession) AllocateTo(_owner common.Address, value *big.Int) (*types.Transaction, error) {
	return _Usdt.Contract.AllocateTo(&_Usdt.TransactOpts, _owner, value)
}

// AllocateTo is a paid mutator transaction binding the contract method 0x08bca566.
//
// Solidity: function allocateTo(address _owner, uint256 value) returns()
func (_Usdt *UsdtTransactorSession) AllocateTo(_owner common.Address, value *big.Int) (*types.Transaction, error) {
	return _Usdt.Contract.AllocateTo(&_Usdt.TransactOpts, _owner, value)
}
...
func (_Usdt *UsdtTransactor) Approve(opts *bind.TransactOpts, _spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdt.contract.Transact(opts, "approve", _spender, amount)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address _spender, uint256 amount) returns(bool)
func (_Usdt *UsdtSession) Approve(_spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdt.Contract.Approve(&_Usdt.TransactOpts, _spender, amount)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address _spender, uint256 amount) returns(bool)
func (_Usdt *UsdtTransactorSession) Approve(_spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdt.Contract.Approve(&_Usdt.TransactOpts, _spender, amount)
}
...
func (_Usdt *UsdtTransactor) Transfer(opts *bind.TransactOpts, dst common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdt.contract.Transact(opts, "transfer", dst, amount)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address dst, uint256 amount) returns(bool)
func (_Usdt *UsdtSession) Transfer(dst common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdt.Contract.Transfer(&_Usdt.TransactOpts, dst, amount)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address dst, uint256 amount) returns(bool)
func (_Usdt *UsdtTransactorSession) Transfer(dst common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdt.Contract.Transfer(&_Usdt.TransactOpts, dst, amount)
}
...
func (_Usdt *UsdtTransactor) TransferFrom(opts *bind.TransactOpts, src common.Address, dst common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdt.contract.Transact(opts, "transferFrom", src, dst, amount)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address src, address dst, uint256 amount) returns(bool)
func (_Usdt *UsdtSession) TransferFrom(src common.Address, dst common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdt.Contract.TransferFrom(&_Usdt.TransactOpts, src, dst, amount)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address src, address dst, uint256 amount) returns(bool)
func (_Usdt *UsdtTransactorSession) TransferFrom(src common.Address, dst common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Usdt.Contract.TransferFrom(&_Usdt.TransactOpts, src, dst, amount)
}
