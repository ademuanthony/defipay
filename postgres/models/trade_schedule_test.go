...
var (
	tradeScheduleDBTypes = map[string]string{`ID`: `uuid`, `AccountID`: `character varying`, `TradeNo`: `integer`, `Date`: `bigint`, `TargetProfitPercentage`: `integer`, `StartDate`: `integer`}
	_                    = bytes.MinRead
)
