...
func (o *Trade) Account(mods ...qm.QueryMod) accountQuery {
...
func (tradeL) LoadAccount(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTrade interface{}, mods queries.Applicator) error {
	var slice []*Trade
	var object *Trade
...
// SetAccount of the trade to the related item.
// Sets o.R.Account to related.
// Adds o to related.R.Trades.
func (o *Trade) SetAccount(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Account) error {
	var err error
	if insert {
...
func (o *Trade) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert trade")
	}
