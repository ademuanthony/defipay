...
var (
	referralPayoutDBTypes = map[string]string{`ID`: `character varying`, `AccountID`: `character varying`, `FromAccountID`: `character varying`, `SubscriptionID`: `character varying`, `Generation`: `integer`, `Amount`: `bigint`, `Date`: `bigint`, `PaymentMethod`: `integer`, `PaymentStatus`: `integer`, `PaymentRef`: `character varying`}
	_                     = bytes.MinRead
)
