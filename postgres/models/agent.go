...
var (
	agentAllColumns            = []string{"id", "slack_username", "name", "balance", "status"}
...
func (o *Agent) TransactionAsignments(mods ...qm.QueryMod) transactionAsignmentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"transaction_asignment\".\"agent_id\"=?", o.ID),
	)
...
func (agentL) LoadTransactionAsignments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAgent interface{}, mods queries.Applicator) error {
	var slice []*Agent
	var object *Agent
	...
	query := NewQuery(
		...
		qm.WhereIn(`transaction_asignment.agent_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Agent) AddTransactionAsignments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TransactionAsignment) error {
	var err error
